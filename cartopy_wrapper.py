...
class Map():
    ...
    def barbs(self,lon,lat,u,v,x=None,y=None,*args,ax=None,transform=None,**kwargs):
        """
        ...
        if x is None:
            ...
            print(lat.shape)
            print(y.shape)
            barb_nh = ax.barbs(x,y,u_nh,v_nh,*args,**kwargs)
        ...
        if x is None:
            ...
            barb_sh = ax.barbs(x,y,u_sh,v_sh,*args,**kwargs)
